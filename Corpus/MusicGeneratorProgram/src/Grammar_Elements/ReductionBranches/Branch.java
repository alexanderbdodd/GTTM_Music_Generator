...
public abstract class Branch implements Serializable{
    ...
    /**
     * 
     * @return a list of levels of the child branches associated with this branch
     */
    ...
    /**
     * 
     * @return all the sub branches of this branch, including the sub branches of its direct
     * sub branches.
     */
