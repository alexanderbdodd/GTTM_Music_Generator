...
public class MetricalContainer implements Serializable{
    ...
    /**
     * 
     * @return the list of metrical beats spanned by the metrical container
     */
    ...
    /**
     * 
     * @param position the position to search for the Beat within the metrical structure
     * @return the Beat at the given position. Returns null if no Beat is found at the given position.
     */
    ...
    */
    ...
    /**
     * 
     * @return the last beat in the metrical span 
     */
    ...
    /**
     * 
     * @return the highest Beat strength value within the metrical struture.
     */
    ...
    /**
     * 
     * @return the lowest value metrical strength within the metrical structure.
     */
