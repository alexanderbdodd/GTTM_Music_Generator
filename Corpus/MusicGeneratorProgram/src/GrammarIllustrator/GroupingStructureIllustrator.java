...
/**A class that is used to draw the grouping structure illustration.
 *
...
public class GroupingStructureIllustrator {
    ...
    /**
     * draws the grouping structure to the given Graphics object in the given position
     * @param g the Graphics object to draw the grouping structure illustration to
     * @param grammar the grammar structure to follow
     * @param mStartX the starting x position to draw the grouping structure
     * @param mStartY the starting y position to draw the grouping structure
     */
