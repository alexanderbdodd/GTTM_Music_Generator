...
public class ProlongationalIllustrator {
    ...
    /**
     *   * draws the  prolongational reduction structure to the given Graphics object in the given position
     * @param g the Graphics object to draw the prolongational reduction structure illustration to
     * @param grammar the grammar structure to follow
     * @param x the starting x position to draw the prolongational reduction structure
     * @param y the starting y position to draw the prolongational reduction structure
     * @param branchX the starting position of the top prolongational branch.
     * @param branchY the starting position of the top prolongational branch.
     */
