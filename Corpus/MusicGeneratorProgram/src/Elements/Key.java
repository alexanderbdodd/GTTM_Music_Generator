...
public class Key implements Comparator {
     ...
     */
    public Key(Key key) {
        this(key.getKeyLetterEnum(), key.getPosition());
    }
     ...
     */
    public KeyLetterEnum getKeyLetterEnum() {
        return key;
    }
    ...
    public int compare(Object obj1, Object obj2) {
        ...
        if (o1.getKeyLetterEnum() == KeyLetterEnum.BS && o1.getPosition() == KeyPositionEnum.getLastPosition(o2.getPosition())
                && o2.getKeyLetterEnum() == KeyLetterEnum.C) {
            return 0;
        }

        if (o1.getKeyLetterEnum() == KeyLetterEnum.C
                && o2.getPosition() == KeyPositionEnum.getNextPosition(o1.getPosition())
                && o2.getKeyLetterEnum() == KeyLetterEnum.B) {
            return 0;
        }
        ...
        if (o1.getPosition().getPosition() < o2.getPosition().getPosition()) {
            ...
            if (o1.getKeyLetterEnum().getKeyPosition() == o2.getKeyLetterEnum().getKeyPosition()) {
                return 0;
            } else if (o1.getKeyLetterEnum().getKeyIdentity() < o2.getKeyLetterEnum().getKeyIdentity()) {
                return -1;
            } else {
                return 1;
            }
    ...
    public static Key getNextKey(Key lastKey) {
        if (lastKey == null) {
            ...
            KeyLetterEnum letter = KeyLetterEnum.getNextNote(lastKey.getKeyLetterEnum())[0];
            KeyPositionEnum position;
            if (letter.getKeyPosition() == KeyLetterEnum.C.getKeyPosition()) {
