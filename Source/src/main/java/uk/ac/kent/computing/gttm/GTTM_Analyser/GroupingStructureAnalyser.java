...
import uk.ac.kent.computing.gttm.GTTM_Analyser.Exceptions.GroupingAnalysisException;
...
public class GroupingStructureAnalyser {
    ...
    /**
     * This returns a calculation of the distance between attack point at
     * position 1 and attack point at position 2.
     *
     * @param pos1 the attack point from which to assess the distance
     ...
     * po2
     * @return the value of the length between attack point at position 1 and
    ...
    public double assessGPR2a(List<Event> events) {
        ...
        return provideIntervalRating(interval1, interval2, interval3);
     ...
     *
     */
    private double provideIntervalRating(int interval1, int interval2, int interval3) {
        ...
        //if interval2 is greater than interval1 and interval3 then return a rating of 1
        //to represent a strong candidate for a boundary.
        //this is an oversimplification at the moment and will need revising at a later stage
     ...
     * the events list fits GPR3b constraints.
     * @throws GroupingAnalysisException thrown if events doesn't contain
     * exactly four AttackEvent objects.
     */
