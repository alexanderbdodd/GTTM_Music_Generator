...
public class AnalyserUtils {
    ...
    public int getDurationBeatExpansion(DurationEnum duration) {
        int spanDistance = 0;
    ...
    public List<Beat> getBeatSpanFromBeat(Beat b, List<Beat> pitchBeats) {
     ...
     public List<Event> createPitchEventList(Map<Beat, Key> chain, List<Beat> beatSpan) {
        ...
        for (Beat beat : beatSpan) {
            ...
            events.add(new AttackEvent(chain.get(beat), DurationEnum.EIGHTH));
            }
        }
    ...
    private DurationEnum getNextLowestDuration(DurationEnum duration) {
        switch (duration) {
            case WHOLE:
                return DurationEnum.HALF;
            case HALF:
                return DurationEnum.QUARTER;
            case QUARTER:
                return DurationEnum.EIGHTH;
            case EIGHTH:
                return DurationEnum.SIXTEENTH;
            case SIXTEENTH:
                return null;
